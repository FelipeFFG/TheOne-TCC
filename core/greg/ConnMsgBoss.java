...
public class ConnMsgBoss {
	...
	// Atualiza ou Adiciona a Conexao 'c' para Mensagem 'm'
	public void updateConnMsg(Connection c, Message m) {

		int pos = getIndexConnection(m);
		ConnMsg objAux;

		// Nova Conexao para Mensagem
		if(pos == -1) {
			addConnMsg(c, m);
		}
		// Atualiza a Conexao da Mensagem
		else {
	...
	// Retorna o Index da Conexao para Mensagem 'm'
	...
	// Retorna o Objeto da Conexao para Mensagem 'm'
	...
	// Remove a mensagem 'm' que foi entrege ao destino ou transmitida (caso a replicacao esteja desabilitada)
	...
	// Remove a conexao 'con' que foi perdida com um no
